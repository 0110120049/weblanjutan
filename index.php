...
<button class="navbar-toggler collapsed" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    	...
    	<div class="container">
           ...
           <!-- The slideshow -->
            <div class="carousel-inner">
    	        ...
    	        <span style="color: #1e05ac">Sistem Informasi Seminar Tugas Akhir</span></h1>
    	        <p class="long_text">SEKOLAH TINGGI TERPADU NURUL FIKRI </p>
    		    </div>
    		    <div class="btn_main">
    			<button type="button" class="btn btn-dark btn-lg"><a href="login-admin.php">Login</a></button>
            </div>
        </div>
    ...
    <div class="carousel-item">
    		...
    		<div class="btn_main">
    			<button type="button" class="btn btn-dark btn-lg"><a href="login-admin.html">Login</a></button>
    		</div>
    </div>
  </div> 
    ...
    <div class="services_main">
    	<div class="container">
    		<div class="creative_taital">
    			<h1 class="creative_text">Tentang SISTA STTN NF</h1>
    			<p style="color: #050000; text-align: center;">Sistem Informasi Tugas Akhir dan Skripsi (SISTA) STT Nurul Fikri mulai online pada tanggal 2 Januari 2020, namun baru akan diimplementasikan pada Semester Genap Tahun Akademik 2020/2021 yang mana untuk melaksanakan Penulisan Skripsi dan Tugas Akhir harus melalui SISTA. Adapun jika prosedur ini tidak ditempuh mahasiswa maka tidak akan dapat mendaftar wisuda meskipun sudah melaksanakan Sidang Sarjana maupun Diploma di Program Studi.</p>
    		</div>
        </div>
    </div>
    <!--Contact_section end -->
