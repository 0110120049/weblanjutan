...
<body>
	<div class="header_main">
		<div class="container">
			<div class="logo"><a href="index.html"><img src="images/logo.jpeg" alt="Image" style="width:90px;height:70px;"></a></div>
		</div>
	</div>
	</div>
	<div class="header">
    		...
    		<div class="row">
    			<div align ="center">
					...
					<br/>
                             ...
                             <legend>Terimakasih! Anda telah terdaftar!</legend>
                             <br/>
                             
                             <button>
                                <ul>
                                   <li><a href="landing-page.html"> Kembali</a></li>
                                </ul>
                            </button>
